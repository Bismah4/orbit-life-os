...
import { ChevronRight, User as UserIcon, Link2, Shield, Clock, Bell, HelpCircle, FileText, LogOut } from "lucide-react";
      ...
      <div className="px-5 pt-5 pb-10 space-y-6">
        ...
        <ul className="rounded-2xl bg-surface ring-1 ring-border divide-y divide-border overflow-hidden">
          {rows.map(({ to, icon: Icon, label, sub }) => (
            <li key={to}>
              <Link to={to as never} className="flex items-center gap-3 px-4 py-3.5 hover:bg-surface-2 transition">
